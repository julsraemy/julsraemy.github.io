...
<div style="position: relative; padding-bottom: 56.25%; height: 0; overflow: hidden; max-width: 100%;">
  <iframe style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;"
    src="https://www.youtube.com/embed/_0otBi4jpJg?si=jQrXchLWY9gE4Eux"
    title="2026 IIIF Annual Conference"
    frameborder="0"
...
The conference proper opened in the Theaterzaal of the Scheltema with a welcome from Geertrui Verbraak (Director of the KB, the national library, and chair of the Dutch Digital Heritage Network / NDE) and a plenary from Martin Kalfatovic, Glen Robson, and Caitlin Perry who gave us an update on the community and the consortium (such as the release candidate of the Presentation API 4.0 and IIIF Coco). Tuesday ran as a single track all day, which made it the most "everyone in one room" day of the week.
